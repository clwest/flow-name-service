...
export default function Home() {
  // Create a state variable for all the Domain info structs
  // Initialize it to an empty array
  const [ domainInfos, setDomainInfo ] = useState([]);
  
  // Load all the Domain info by running the Cadence script
        ...
        <div className={styles.domainsContainer}>
          {
            ...
            domainInfos.length === 0 ? (
              ...
              // Otherwise loop over the array and render info
              // about each domain
